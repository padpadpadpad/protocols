...
conda create -n autocycler -c conda-forge -c bioconda -c defaults autocycler canu flye metamdbg miniasm necat raven-assembler plassembler nextdenovo nextpolish fastp filtlong sourmash seqkit dnappler
...
dnaapler all -i assemblies/filtered_assemblies/ecoli/debruijn/consensus_assembly.gfa  -o assemblies/filtered_assemblies/ecoli/debruijn/dnaapler -p ecoli_mg1655 -t 8
```
